...
const SHARED_API_BASE = `${PRODUCTION_URL}/api`;

const getBaseUrl = () => {
  // Khi chạy local thì trỏ về backend local, còn trên Render thì dùng server chung.
...
export const PAYMENT_REQUEST_API = {
  GET_ALL: `${SHARED_API_BASE}/payment-requests`,
  CREATE: `${SHARED_API_BASE}/payment-requests`,
  UPDATE_STATUS: (id) => `${SHARED_API_BASE}/payment-requests/${id}`,
};

// ===== RATING APIs (Home, AdminDashboard) =====
export const RATING_API = {
  GET_ALL: `${SHARED_API_BASE}/ratings`,
  CREATE: `${SHARED_API_BASE}/ratings`,
  UPDATE_STATUS: (id) => `${SHARED_API_BASE}/ratings/${id}`,
};

// ===== STAFF CALL APIs (Home, CashierPage, AdminDashboard) =====
export const STAFF_CALL_API = {
  GET_ALL: `${SHARED_API_BASE}/staff-calls`,
  CREATE: `${SHARED_API_BASE}/staff-calls`,
  UPDATE_STATUS: (id) => `${SHARED_API_BASE}/staff-calls/${id}`,
};
